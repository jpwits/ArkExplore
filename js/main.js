...
//var mapName = 'pyramid';
//var mapName = 'KingTutAddOn';
//var mapName = 'KingTut';
//var mapName = 'nefertari+tomb1';
var mapName = 'ValleyKings';
...
function initMap(gl) {
    ...
    //map.load('maps/pyramid/' + mapName +'.bsp', tesselation);
    //map.load('maps/KingTut/' + mapName +'.bsp', tesselation);
    map.load('maps/ValleyKings/' + mapName +'.bsp', tesselation);
